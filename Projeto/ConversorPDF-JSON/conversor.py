...
pdf_path = 'C:/Users/Carlos/Downloads/extrator-diario-completo-2023-07-20/diario.pdf'
...
# Imprimir o conteúdo do PDF para análise
print(pdf_text)

json_output_path = 'C:/Users/Carlos/Downloads/extrator-diario-completo-2023-07-20/output.json'
